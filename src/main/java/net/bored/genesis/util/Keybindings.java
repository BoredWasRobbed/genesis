...
public class Keybindings {
    ...
    public static final String KEY_POWER = "key.genesis.power"; // New Power Key
    ...
    public static final KeyMapping POWER_KEY = new KeyMapping(KEY_POWER, KeyConflictContext.IN_GAME, InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_G, KEY_CATEGORY_GENESIS); // Default to 'G'
